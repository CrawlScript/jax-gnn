...
from .planetoid import PlanetoidDataset, CoraDataset, CiteseerDataset, PubmedDataset, \
...
#     AmazonPhotoDataset
# from tf_geometric.datasets.coauthor import CoauthorDataset, CoauthorCSDataset,